...
const Footer = () => {
  ...
  <Flex flexDirection="column" justifyContent="center" alignItems="flex-start">
    <Text color="#1A202C" fontSize="14.88px" fontWeight="700" mb="10px" ml={120}>
...
const TextItems = () => {
  const textData = [
    ...
    { text: "Điều kiện giao dịch chung", fontSize: "14.30px", fontWeight: "400" },
    ...
    { text: "Ưu đãi dành cho danh nghiệp", fontSize: "14.30px", fontWeight: "400" },
    ...
    { text: "Giao hành và lắp đặt tại nhà", fontSize: "14.30px", fontWeight: "400" },
